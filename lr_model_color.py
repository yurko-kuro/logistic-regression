...
class CatImagePredictor:
    def __init__(self, image_path=None):
        ...
        # Configure logging
        logging.basicConfig(
            filename='model_prediction_color.log',  # Log file name
    ...
    def load_model(self, model_path='model_weights_color.npz'):
    ...
    def preprocess_image(self, image_path):
        ...
        # Resize image and normalize for color images
    ...
    def predict_image(self, image_path):
        ...
        img_resized, img = self.preprocess_image(image_path)
